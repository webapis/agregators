...
function template({ federatedId, email, emailVerified, kind, localId, needConfirmation, oauthAccessToken, photoUrl, providerId, screenName, idToken, refreshToken, expiresIn }) {
    return `<!DOCTYPE html>
<html lang="en">
