            ...
            if (result) {
                ...
                workflows && workflows.forEach(wf => {
                    ...
                    document.getElementById(`${workflowName}-workflow-config-btn`).addEventListener('click', (e) => {
                        e.preventDefault()
                        window.pageStore.dispatch({ type: window.actionTypes.WORKFLOW_SELECTED, payload: { workflowName, workflowKey, workflowDescription } })
                    ...
                    document.getElementById(`${workflowName}-workflow-editor-btn`).addEventListener('click', (e) => {
                        ...
                        try {
                            ...
                            */
                            ...
                            window.pageStore.dispatch({ type: window.actionTypes.WORKFLOW_UPDATE, payload: { workflowName, workflowKey, workflowDescription } })
