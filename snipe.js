...
const prom = new Promise((resolve, reject) => {
  var request = https.request(options, function (responce) {
      ...
      responce.on("end", async function () {
        const {refreshToken} =JSON.parse(body)
          console.log("Body", body);
      const resultOne=await renewIdToken({api_key:'AIzaSyDb8Z27Ut0WJ-RH7Exi454Bpit9lbARJeA',refresh_token:refreshToken})
      const resultTwo=await renewIdToken({api_key:'AIzaSyDb8Z27Ut0WJ-RH7Exi454Bpit9lbARJeA',refresh_token:resultOne.refresh_token})
debugger;
          return  resolve(body)
      });
...
debugger;
  ...
  request.write(JSON.stringify({ postBody: `access_token=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&providerId=github.com`, requestUri: "https://turkmenistan-market.firebaseapp.com/__/auth/handler", returnIdpCredential: true, returnSecureToken: true }))
  request.end()
})
...
//   require('dotenv').config()
//   debugger;
//   const {authWithFirebase}=require('./root/utils/github/index')
//   const  response =await authWithFirebase({access_token:'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',key:'AIzaSyDb8Z27Ut0WJ-RH7Exi454Bpit9lbARJeA'})
// debugger;
// })()
