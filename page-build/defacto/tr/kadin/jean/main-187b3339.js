  ...
  class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      Promise.all([
        ...
        import('./pl-page-tabs-574b72bb.js'),
      ...
      <div class="container">
        <pl-page-tabs></pl-page-tabs>
          ...
          <div id="urun-container" class="row ${selected !== 'urunler' &&
            'd-none'} bg-warning position-relative">
            <pl-search-result class="bg-success position-absolute top-50 start-0 translate-middle"></pl-search-result>
            </div>
