customElements.define(
  ...
  class extends HTMLElement {
    ...
    connectedCallback() {
      window.onscroll = () => {
        window.pageStore.getState();
        window.pageStore.dispatch({ type: window.actionTypes.PAGE_SCROLLED });
        console.log('document.body.scrollTop', document.body.scrollTop);
        console.log('document.body.scrollBottom', document.body.scrollHeight);
      };
      if (window.pageStore) {
