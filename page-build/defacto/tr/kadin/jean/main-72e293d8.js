  ...
  class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      Promise.all([
        ...
        import('./pl-page-tabs-59cb190b.js'),
      ...
      this.innerHTML = /*html*/ `
        ...
        <pl-page-tabs></pl-page-tabs>
          ...
          <div id="urun-container" class="row ${selected !== 'urunler' &&
            'd-none'} pt-5 bg-warning position-fixed mt-5" style="height:${height}px;overflow: auto;" >
    ...
    const urunContainer =   document
    .getElementById('urun-container');
    urunContainer
        .addEventListener('scroll', () => {
          const { state: { autoscroll } } = window.pageStore;
          if (autoscroll) {
            console.log(' body.scrollHeight', urunContainer.scrollHeight);
            console.log(
              ' body.scrollTop',
            ...
            if (
              urunContainer.scrollTop + document.body.clientHeight ===
