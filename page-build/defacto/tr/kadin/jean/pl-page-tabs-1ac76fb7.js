customElements.define(
  ...
  class extends HTMLElement {
    ...
    render({ selected }) {
      this.innerHTML =`
      <div class="nav nav-tabs position-fixed bg-light d-flex  flex-column justify-content-center" style="z-index:1000; solid white;width:100%;">
      ...
      <ul class=" d-flex justify-content-center border-bottom  border-1">
