  ...
  class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      Promise.all([
        ...
        import('./pl-page-tabs-b5eaebf6.js'),
    ...
    render({ selected, value }) {
      ...
      this.innerHTML = /*html*/ `
        ...
        <pl-page-tabs>
        <div class="d-flex">
        <page-tab name="secenekler-container" title="Seceneler">
          <div slot="title" class="bg-warning">Secenekler.....</div>
        </page-tab>
        <page-tab name="urun-container" title="Ürünler">
        <div slot="title" class="bg-success">
            Urunler.....
        </div>
        </page-tab>
        </div>
