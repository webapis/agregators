customElements.define(
  ...
  class extends HTMLElement {
    ...
    render({ selected }) {
      this.innerHTML = `
      <div class="nav nav-tabs position-fixed bg-light d-flex justify-content-center" style="z-index:1000;border-bottom:5px solid white;width:100%;">
      <div class="input-group mb-3 d-flex justify-content-center row">
