...
for (let filepath of files) {
    ...
    fs.writeFileSync(`${filepath}.B64`,encryptedData.toString('base64'),{encoding:'utf-8'})
...
const encryptedData =encrypt(data)
debugger;
fs.writeFileSync(`${envFilePath}.B64`,encryptedData.toString('base64'),{encoding:'utf-8'})
debugger;
