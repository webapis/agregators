  ...
  class extends HTMLElement {
    ...
    render() {
      ...
      <div class="row">
       ...
       <div class="d-flex flex-column justify-content-between" style="height:45px">
       <img src="https://dfcdn.defacto.com.tr/Assets/dist/images/logo.png" width="50"/>
       <span class="badge rounded-pill bg-light text-dark">233</span>
       </div>
       </a>
       </div>
        <a href="#" class="nav-link">Bluz</a>
        <h5 class="fw-light">D</h5>
        <a href="#" class="nav-link">Deri ceket</a>
        <a href="#" class="nav-link">Dış giyim</a>
        <h5 class="fw-light">E</h5>
        <a href="#" class="nav-link">Elbise</a>
        <a href="#" class="nav-link">Eşofman altı</a>
        <a href="#" class="nav-link">Eşofman takımları</a>
        <a href="#" class="nav-link">Etek</a>
        <a href="#" class="nav-link">Ev giyim</a>
        </div>
        </div>
        `;
    }
